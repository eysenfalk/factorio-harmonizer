...
-- Patch: PATCH_BURNER-INSERTER_COMPREHENSIVE
-- Description: Comprehensive recipe compatibility patch for burner-inserter with actual mod-specific recipes
-- Fixes: MOD_RECIPE_CONFLICT_BURNER-INSERTER


-- Comprehensive compatibility patch for burner-inserter
-- Fixes conflict between: lignumis, base
-- Severity: CRITICAL
-- Creates all mod-specific alternative recipes

if data.raw.recipe["burner-inserter"] then
    local original_recipe = data.raw.recipe["burner-inserter"]

    
    -- Lignumis version of burner-inserter
    local lignumis_recipe = table.deepcopy(original_recipe)
    lignumis_recipe.name = "burner-inserter-lignumis"
    lignumis_recipe.localised_name = {"", "burner-inserter", " (Lignumis)"}
    lignumis_recipe.enabled = true
    lignumis_recipe.order = (lignumis_recipe.order or "a") .. "-lignumis"

    
    data:extend({lignumis_recipe})
    
    -- Base Game version of burner-inserter
    local base_recipe = table.deepcopy(original_recipe)
    base_recipe.name = "burner-inserter-base"
    base_recipe.localised_name = {"", "burner-inserter", " (Base Game)"}
    base_recipe.enabled = true
    base_recipe.order = (base_recipe.order or "a") .. "-base"

    
    data:extend({base_recipe})
    
    -- Disable original recipe since we have alternatives
    original_recipe.enabled = false
    original_recipe.hidden = true
end


-- Patch: PATCH_ELECTRONIC-CIRCUIT_COMPREHENSIVE
-- Description: Comprehensive recipe compatibility patch for electronic-circuit with actual mod-specific recipes
-- Fixes: CONFLICT_RECIPE_ELECTRONIC-CIRCUIT


-- Comprehensive compatibility patch for electronic-circuit
-- Fixes conflict between: aai-industry, base
-- Severity: HIGH
-- Creates all mod-specific alternative recipes

if data.raw.recipe["electronic-circuit"] then
    local original_recipe = data.raw.recipe["electronic-circuit"]

    
    -- AAI Industry version of electronic-circuit
    local aai_industry_recipe = table.deepcopy(original_recipe)
    aai_industry_recipe.name = "electronic-circuit-aai_industry"
    aai_industry_recipe.localised_name = {"", "electronic-circuit", " (AAI Industry)"}
    aai_industry_recipe.enabled = true
    aai_industry_recipe.order = (aai_industry_recipe.order or "a") .. "-aai_industry"

    
    data:extend({aai_industry_recipe})
    
    -- Base Game version of electronic-circuit
    local base_recipe = table.deepcopy(original_recipe)
    base_recipe.name = "electronic-circuit-base"
    base_recipe.localised_name = {"", "electronic-circuit", " (Base Game)"}
    base_recipe.enabled = true
    base_recipe.order = (base_recipe.order or "a") .. "-base"
...
-- Patch: PATCH_EXPRESS-TRANSPORT-BELT_COMPREHENSIVE
-- Description: Comprehensive recipe compatibility patch for express-transport-belt with actual mod-specific recipes
-- Fixes: MISSING_DEPS_EXPRESS-TRANSPORT-BELT


-- Comprehensive compatibility patch for express-transport-belt
-- Fixes conflict between: base
-- Severity: HIGH
-- Creates all mod-specific alternative recipes

if data.raw.recipe["express-transport-belt"] then
    local original_recipe = data.raw.recipe["express-transport-belt"]

    
    -- Base Game version of express-transport-belt
    local base_recipe = table.deepcopy(original_recipe)
    base_recipe.name = "express-transport-belt-base"
    base_recipe.localised_name = {"", "express-transport-belt", " (Base Game)"}
    base_recipe.enabled = true
    base_recipe.order = (base_recipe.order or "a") .. "-base"
...
-- Patch: PATCH_PROCESSING-UNIT_COMPREHENSIVE
-- Description: Comprehensive recipe compatibility patch for processing-unit with actual mod-specific recipes
-- Fixes: MISSING_DEPS_PROCESSING-UNIT


-- Comprehensive compatibility patch for processing-unit
-- Fixes conflict between: base
-- Severity: HIGH
-- Creates all mod-specific alternative recipes

if data.raw.recipe["processing-unit"] then
    local original_recipe = data.raw.recipe["processing-unit"]

    
    -- Base Game version of processing-unit
    local base_recipe = table.deepcopy(original_recipe)
    base_recipe.name = "processing-unit-base"
    base_recipe.localised_name = {"", "processing-unit", " (Base Game)"}
    base_recipe.enabled = true
    base_recipe.order = (base_recipe.order or "a") .. "-base"
...
-- Fixes conflict between: Krastorio2, lignumis
-- Severity: HIGH
...
-- Fixes conflict between: cubium, crushing-industry, alien-module, aai-vehicles-warden, planet-muluna, bobassembly, corrundum, bobtech, dea-dia-system, FluidMustFlow, Flare Stack, DoubleWagons, base, bobplates, rubia, aai-vehicles-chaingunner, castra, Spaghetorio, boblogistics, RampantArsenalFork, bobpower, vtk-cannon-turret, secretas, aai-industry, tenebris-prime, Electric Furnaces, bzcarbon, bobequipment, metal-and-stars, wood-military, Krastorio2-spaced-out, quirkycat_boron, bobmining, StopgapNukes, bobgreenhouse, RenaiTransportation, tenebris, PlutoniumEnergy, More_Ammo, Moshine, equipment-gantry, early-agriculture, bzsilicon, terrapalus, Aircraft-space-age, Krastorio2, bobwarfare, aai-vehicles-hauler, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: astroponics, aquilo-seabloom-algaculture, wood-industry, planet-muluna, biochemistry, corrundum, bobtech, vulcanus-sulfuric-bacteria, base, bobplates, Wood-Walls, lilys-cubeine, metal-and-stars, wood-military, Krastorio2-spaced-out, enemyracemanager, bobgreenhouse, bobelectronics, lignumis, Krastorio2, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, Cold_biters, cubium, crushing-industry, More_Repair_Packs, alloy-smelting, aquilo-seabloom-algaculture, alien-module, bobenemies, bobassembly, corrundum, dea-dia-system, bobvehicleequipment, Flare Stack, FluidMustFlow, quirkycat_machines, aai-vehicles-laser-tank, minimalist-rails, base, bobplates, rubia, castra, slp-dyson-sphere-reworked, atan-nuclear-science, Spaghetorio, boblogistics, bobpower, aai-vehicles-flame-tumbler, lilys-cubeine, Cerys-Moon-of-Fulgora, aai-industry, aai-vehicles-flame-tank, Robocharger-Updated, se-space-trains, secretas, shield-projector, tenebris-prime, vtk-cannon-turret, bzcarbon, bobequipment, metal-and-stars, Krastorio2-spaced-out, Warehousing, bobmining, StopgapNukes, OmegaDrill, RenaiTransportation, tenebris, PlutoniumEnergy, More_Ammo, VoidProcessing, HelicopterRevival, aai-vehicles-ironclad, early-agriculture, Hovercrafts, foundry-restructuring, Planet-Hopper, bobrevamp, aai-signal-transmission, bzsilicon, Fluid-level-indicator, Aircraft-space-age, bobmodules, Krastorio2, bobwarfare, lex-aircraft, snouz_better_substation, grappling-gun
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, crushing-industry, alien-module, aai-vehicles-warden, bobenemies, bobassembly, corrundum, bobtech, dea-dia-system, bobvehicleequipment, Flare Stack, FluidMustFlow, DoubleWagons, base, bobplates, rubia, aai-vehicles-chaingunner, castra, boblogistics, RampantArsenalFork, bobpower, Robocharger-Updated, lilys-cubeine, secretas, aai-industry, aai-vehicles-flame-tank, bzcarbon, bobequipment, Krastorio2-spaced-out, bobmining, OmegaDrill, RenaiTransportation, HelicopterRevival, aai-vehicles-ironclad, Hovercrafts, foundry-restructuring, bzsilicon, Krastorio2, bobwarfare, aai-vehicles-hauler, grappling-gun
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, crushing-industry, alien-module, bobassembly, corrundum, bobvehicleequipment, base, bobplates, rubia, castra, Spaghetorio, boblogistics, RampantArsenalFork, bobpower, lilys-cubeine, Cerys-Moon-of-Fulgora, aai-industry, secretas, Igrys, bobequipment, wood-military, Krastorio2-spaced-out, bobgreenhouse, RenaiTransportation, bobelectronics, PlutoniumEnergy, More_Ammo, lignumis, aai-signal-transmission, Krastorio2, bobmodules, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, More_Repair_Packs, crushing-industry, aquilo-seabloom-algaculture, alien-module, aai-vehicles-warden, bobassembly, corrundum, dea-dia-system, bobvehicleequipment, Flare Stack, base, bobplates, rubia, castra, boblogistics, RampantArsenalFork, bobpower, vtk-cannon-turret, Cerys-Moon-of-Fulgora, Automatic_Train_Painter, TimeTools, tenebris-prime, Electric Furnaces, bobequipment, metal-and-stars, wood-military, Krastorio2-spaced-out, bobmining, RenaiTransportation, bobelectronics, tenebris, Moshine, early-agriculture, janus, Planet-Hopper, lignumis, terrapalus, Aircraft-space-age, bobmodules, Krastorio2, bobwarfare, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, cubium, More_Repair_Packs, crushing-industry, alloy-smelting, bobenemies, bobassembly, bobtech, dea-dia-system, bobvehicleequipment, aai-vehicles-laser-tank, base, bobplates, rubia, castra, boblogistics, RampantArsenalFork, bobpower, aai-vehicles-flame-tumbler, Robocharger-Updated, Cerys-Moon-of-Fulgora, secretas, vtk-cannon-turret, tenebris-prime, bobequipment, PavementDriveAssistContinued, metal-and-stars, Krastorio2-spaced-out, Warehousing, bobmining, StopgapNukes, OmegaDrill, RenaiTransportation, bobelectronics, tenebris, PlutoniumEnergy, Moshine, Hovercrafts, janus, Aircraft-space-age, bobmodules, Krastorio2, bobwarfare, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, cubium, More_Repair_Packs, crushing-industry, astroponics, RampantFixed, bobassembly, corrundum, bobvehicleequipment, cerys-lunaponics, base, bobplates, rubia, castra, fulgora-coralmium-agriculture, atan-nuclear-science, slp-dyson-sphere-reworked, boblogistics, bobpower, se-space-trains, Cerys-Moon-of-Fulgora, aai-industry, secretas, shield-projector, bobequipment, metal-and-stars, Krastorio2-spaced-out, enemyracemanager, bobmining, StopgapNukes, OmegaDrill, RenaiTransportation, bobelectronics, Kux-OrbitalIonCannon, PlutoniumEnergy, orbital-transfer, Moshine, HelicopterRevival, Hovercrafts, janus, aai-signal-transmission, Aircraft-space-age, bobmodules, bobwarfare, Krastorio2, atomic-artillery-reborn, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, bobmining, OmegaDrill, Krastorio2, aai-industry
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, cubium, crushing-industry, RampantFixed, corrundum, dea-dia-system, bobvehicleequipment, bobplates, rubia, castra, boblogistics, secretas, aai-industry, Krastorio2-spaced-out, OmegaDrill, RenaiTransportation, Kux-OrbitalIonCannon, orbital-transfer, Hovercrafts, aai-signal-transmission, Aircraft-space-age, Krastorio2, bobwarfare, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, cubium, snouz-big-accumulator, crushing-industry, astroponics, alloy-smelting, Moshine-assets, corrundum, rubia, fulgora-coralmium-agriculture, atan-nuclear-science, bobpower, Cerys-Moon-of-Fulgora, aai-industry, secretas, tenebris-prime, metal-and-stars, Krastorio2-spaced-out, Warehousing, RenaiTransportation, tenebris, PlutoniumEnergy, Moshine, Krastorio2, snouz-big-solar-panel, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, bobplates, rubia, lilys-cubeine, bobassembly, aai-industry, Krastorio2, Electric Furnaces
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, crushing-industry, Warehousing, alloy-smelting, bobplates, tenebris-prime, castra, lignumis, boblogistics, planet-muluna, bobassembly, aai-industry, Cerys-Moon-of-Fulgora, tenebris, dea-dia-system, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: crushing-industry, quirkycat_base, wood-industry, Moshine-assets, aai-industry, quirkycat_glass, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, crushing-industry, bztin, alien-module, wood-industry, Moshine-assets, corrundum, bobtech, quirkycat_glass, vulcanus-sulfuric-bacteria, bobplates, rubia, fulgora-coralmium-agriculture, quirkycat_recycle, boblogistics, secretas, aai-industry, bzcarbon, bzlead, metal-and-stars, Krastorio2-spaced-out, bobgreenhouse, bztitanium, bobrevamp, bzsilicon, Krastorio2, bzzirconium
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: early-agriculture, crushing-industry, quirkycat_base, aai-industry, quirkycat_glass, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: snouz-big-accumulator, corrundum, bobvehicleequipment, rubia, castra, Spaghetorio, boblogistics, bobpower, se-space-trains, Cerys-Moon-of-Fulgora, aai-industry, secretas, TimeTools, bobequipment, Krastorio2-spaced-out, RenaiTransportation, bobelectronics, lignumis, terrapalus, Krastorio2, bobmodules, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: HelicopterRevival, wood-military, minimalist-rails, Krastorio2-spaced-out, rubia, boblogistics, RenaiTransportation, Krastorio2, corrundum, aai-industry, grappling-gun
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: alloy-smelting, bobplates, bobpower, aai-industry, bobtech, Flare Stack, Electric Furnaces
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Cold_biters, alien-module, biochemistry, bobvehicleequipment, aai-vehicles-laser-tank, rubia, castra, boblogistics, bobpower, Robocharger-Updated, se-space-trains, secretas, shield-projector, bobequipment, metal-and-stars, Krastorio2-spaced-out, Kux-OrbitalIonCannon, HelicopterRevival, janus, aai-signal-transmission, Aircraft-space-age, Krastorio2, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: HelicopterRevival, Hovercrafts, Krastorio2-spaced-out, rubia, aai-vehicles-chaingunner, RenaiTransportation, vtk-cannon-turret, Krastorio2, secretas, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: HelicopterRevival, aai-vehicles-ironclad, cubium, crushing-industry, Hovercrafts, Krastorio2-spaced-out, foundry-restructuring, castra, rubia, RenaiTransportation, aai-vehicles-flame-tumbler, Cerys-Moon-of-Fulgora, Krastorio2, aai-vehicles-flame-tank, FluidMustFlow, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: equipment-gantry, metal-and-stars, Warehousing, aai-vehicles-warden, RenaiTransportation, aai-vehicles-hauler
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Cold_biters, aai-vehicles-ironclad, cubium, castra
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: aai-vehicles-ironclad, Krastorio2-spaced-out, castra, StopgapNukes, RenaiTransportation, vtk-cannon-turret, Aircraft-space-age, corrundum, Krastorio2, bobwarfare, PlutoniumEnergy
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, castra, Krastorio2, bobwarfare, lex-aircraft, aai-vehicles-laser-tank
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Hovercrafts, terrapalus, secretas, Kux-OrbitalIonCannon, bobwarfare, aai-vehicles-laser-tank
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, Krastorio2-spaced-out, bobplates, bobrevamp, wood-industry, planet-muluna, Aircraft-space-age, Cerys-Moon-of-Fulgora, corrundum, Krastorio2, secretas, bobwarfare, aai-vehicles-laser-tank
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, slp-dyson-sphere-reworked, castra, aai-vehicles-warden, RampantArsenalFork, bobenemies, RampantFixed, Krastorio2, Kux-OrbitalIonCannon, bobwarfare, atomic-artillery-reborn, PlutoniumEnergy
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, crushing-industry, alloy-smelting, alien-module, aai-vehicles-warden, Moshine-assets, quirkycat_machines, vulcanus-sulfuric-bacteria, bobplates, quirkycat_recycle, bzcarbon, metal-and-stars, Krastorio2-spaced-out, RenaiTransportation, bobelectronics, Moshine, Krastorio2, bobwarfare, grappling-gun
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2, Krastorio2-spaced-out, Aircraft-space-age, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: HelicopterRevival, Hovercrafts, Krastorio2-spaced-out, Aircraft-space-age, Krastorio2, bobwarfare, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, More_Repair_Packs, astroponics, RampantFixed, bobvehicleequipment, rubia, castra, fulgora-coralmium-agriculture, lilys-cubeine, Cerys-Moon-of-Fulgora, secretas, shield-projector, bobequipment, metal-and-stars, Krastorio2-spaced-out, StopgapNukes, Kux-OrbitalIonCannon, PlutoniumEnergy, orbital-transfer, Hovercrafts, janus, lignumis, Aircraft-space-age, Krastorio2, bobwarfare, lex-aircraft
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: PlutoniumEnergy, Aircraft-space-age, StopgapNukes
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Hovercrafts, Krastorio2-spaced-out, castra, Aircraft-space-age, Krastorio2, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, crushing-industry, Krastorio2-spaced-out, bobplates, alien-module, tenebris-prime, castra, Spaghetorio, quirkycat_recycle, Moshine-assets, Cerys-Moon-of-Fulgora, bobelectronics, corrundum, Krastorio2, quirkycat_machines, tenebris, bzlead
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, crushing-industry, Krastorio2-spaced-out, bobplates, alien-module, Spaghetorio, quirkycat_recycle, Moshine-assets, Krastorio2, corrundum, bzlead
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: quirkycat_recycle, alien-module
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, alloy-smelting, wood-industry
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, crushing-industry, astroponics, alloy-smelting, Krastorio2-spaced-out, castra, Spaghetorio, wood-industry, Moshine-assets, RampantFixed, Cerys-Moon-of-Fulgora, corrundum, vulcanus-sulfuric-bacteria, bzcarbon, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, aquilo-seabloom-algaculture, rubia, fulgora-coralmium-agriculture, planet-muluna, biochemistry, secretas, bztitanium
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2, Krastorio2-spaced-out, astroponics, aquilo-seabloom-algaculture
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, Krastorio2-spaced-out, aquilo-seabloom-algaculture, slp-dyson-sphere-reworked, promethium-quality, StopgapNukes, Fluid-level-indicator, RenaiTransportation, lilys-cubeine, secretas, corrundum, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, Krastorio2-spaced-out, aquilo-seabloom-algaculture, slp-dyson-sphere-reworked, promethium-quality, RenaiTransportation, RampantFixed, Cerys-Moon-of-Fulgora, secretas, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, aquilo-seabloom-algaculture, RenaiTransportation, secretas
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, aquilo-seabloom-algaculture, rubia, lignumis, biochemistry, secretas, corrundum, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, astroponics, secretas, corrundum, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, Flow Control, astroponics, planet-muluna, bobassembly, FluidMustFlow, dea-dia-system, Flare Stack, bobplates, rubia, castra, boblogistics, bobpower, lilys-cubeine, secretas, metal-and-stars, Krastorio2-spaced-out, bobmining, RenaiTransportation, foundry-restructuring, Planet-Hopper, Fluid-level-indicator, Krastorio2, bobwarfare, grappling-gun
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, crushing-industry, astroponics, bztin, Krastorio2-spaced-out, Spaghetorio, lignumis, bzsilicon, Moshine-assets, vulcanus-sulfuric-bacteria, lilys-cubeine, corrundum, common-prototypes, bzzirconium, bzlead
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, astroponics, planet-muluna
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bztitanium, astroponics, Krastorio2-spaced-out, planet-muluna
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, Krastorio2-spaced-out, bobplates, atan-nuclear-science, StopgapNukes, RampantFixed, lilys-cubeine, Cerys-Moon-of-Fulgora, Krastorio2, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, PlutoniumEnergy, atan-nuclear-science
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: HelicopterRevival, cubium, minimalist-rails, Krastorio2-spaced-out, rubia, atan-nuclear-science, RenaiTransportation, Cerys-Moon-of-Fulgora, bobassembly, Krastorio2
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: PlutoniumEnergy, atan-nuclear-science, Cerys-Moon-of-Fulgora
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, metal-and-stars, secretas, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: ballistic_missile, metal-and-stars, rubia, Planet-Hopper
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, enemyracemanager, RenaiTransportation, biochemistry, corrundum
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Cold_biters, cubium, More_Repair_Packs, biochemistry, bobassembly, corrundum, bobvehicleequipment, quirkycat_glass, bobplates, castra, fulgora-coralmium-agriculture, boblogistics, lilys-cubeine, secretas, vtk-cannon-turret, tenebris-prime, bobequipment, metal-and-stars, Krastorio2-spaced-out, StopgapNukes, bobelectronics, Kux-OrbitalIonCannon, tenebris, More_Ammo, HelicopterRevival, bobrevamp, lignumis, Fluid-level-indicator, Krastorio2, bobmodules, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: crushing-industry, Spaghetorio, quirkycat_recycle, biochemistry, vulcanus-sulfuric-bacteria
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2, Krastorio2-spaced-out, bobassembly, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, bobassembly, corrundum
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobpower, Electric Furnaces, bobassembly, bobplates
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobrevamp, bobelectronics, bobplates
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobenemies, bobvehicleequipment, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobenemies, bobplates, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Cold_biters, bobwarfare, Krastorio2, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, bobwarfare, Electric Furnaces, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, Krastorio2, bobmodules, secretas, bobvehicleequipment, bobwarfare, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, bobmodules, secretas, bobvehicleequipment, bobwarfare, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, bobvehicleequipment, Moshine, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Hovercrafts, Krastorio2, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, PlutoniumEnergy, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, slp-dyson-sphere-reworked, maraxsis, StopgapNukes, secretas, bobvehicleequipment, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, bobequipment
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, bobplates, castra, Spaghetorio, bobrevamp, StopgapNukes, bobgreenhouse, Moshine-assets, vulcanus-sulfuric-bacteria, corrundum, tenebris-prime, More_Ammo
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, rubia, boblogistics, Krastorio2, long_stack_inserter
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, boblogistics, Krastorio2, Cerys-Moon-of-Fulgora
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, rubia, boblogistics, Krastorio2
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, boblogistics, OmegaDrill, Krastorio2, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, cubium, Krastorio2, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, lignumis, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, rubia, boblogistics, Krastorio2, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, boblogistics, Krastorio2, secretas, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, boblogistics, RenaiTransportation, Krastorio2, secretas
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, secretas, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, rubia, boblogistics, RenaiTransportation, Krastorio2, bobtech, bobwarfare
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, rubia, boblogistics, se-space-trains, Krastorio2
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, boblogistics, RenaiTransportation, se-space-trains, DoubleWagons
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, se-space-trains, DoubleWagons, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobtech, cubium, secretas, boblogistics
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, Krastorio2-spaced-out, bobplates, rubia, StopgapNukes, vtk-cannon-turret, Krastorio2, Cerys-Moon-of-Fulgora, bobwarfare, PlutoniumEnergy, More_Ammo
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobpower, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, Hovercrafts, bobpower, Cerys-Moon-of-Fulgora, secretas
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, snouz-big-accumulator, slp-dyson-sphere-reworked, bobpower, RampantFixed, RenaiTransportation, Kux-OrbitalIonCannon
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, RenaiTransportation, bobpower, Krastorio2, snouz_better_substation
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, slp-dyson-sphere-reworked, bobpower, Krastorio2, Kux-OrbitalIonCannon, secretas, snouz-big-solar-panel
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bobpower, cubium, corrundum
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, bobpower, Krastorio2, Cerys-Moon-of-Fulgora, corrundum, secretas
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, cubium, Igrys, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, bobtech
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, corrundum, bobtech, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: castra, bobwarfare, Cerys-Moon-of-Fulgora, StopgapNukes
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, bzcarbon
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bzsilicon, bzcarbon
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, rubia, castra, slp-dyson-sphere-reworked, RenaiTransportation, lilys-cubeine, secretas, bzcarbon
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, bztin, bzlead
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: crushing-industry, quirkycat_recycle, bzlead
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: PlutoniumEnergy, crushing-industry, bzlead
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: bzsilicon, Krastorio2-spaced-out, Krastorio2
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cerys-lunaponics, crushing-industry, bztin, quirkycat_recycle
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: crushing-industry, bztitanium, bzzirconium, quirkycat_recycle
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, Krastorio2-spaced-out, secretas, bzzirconium
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, rubia, castra, Krastorio2, PlutoniumEnergy, More_Ammo
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, Krastorio2-spaced-out, slp-dyson-sphere-reworked, castra, Cerys-Moon-of-Fulgora, secretas, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, castra, lignumis, RenaiTransportation, RampantFixed, secretas, tenebris, tenebris-prime
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, cubium, castra, Spaghetorio, RenaiTransportation, Cerys-Moon-of-Fulgora, secretas, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, slp-dyson-sphere-reworked, castra, promethium-quality, RampantFixed, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, metal-and-stars, Krastorio2-spaced-out, rubia, castra, lignumis, StopgapNukes, RenaiTransportation, Krastorio2, corrundum, Kux-OrbitalIonCannon, tenebris, tenebris-prime, PlutoniumEnergy, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, metal-and-stars, Cerys-Moon-of-Fulgora
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, crushing-industry, rubia, fulgora-coralmium-agriculture, Spaghetorio, quirkycat_recycle, Cerys-Moon-of-Fulgora
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, crushing-industry, Cerys-Moon-of-Fulgora, quirkycat_recycle
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Krastorio2-spaced-out, StopgapNukes, lilys-cubeine, Krastorio2, Cerys-Moon-of-Fulgora
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, secretas, lignumis, common-prototypes
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, rubia, secretas, corrundum
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, crushing-industry, Krastorio2-spaced-out, lignumis, lilys-cubeine, vulcanus-sulfuric-bacteria
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: foundry-restructuring, cubium, rubia, RenaiTransportation
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: cubium, Spaghetorio
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, cubium, Krastorio2-spaced-out
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: dea-dia-system, RenaiTransportation, rubia
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, Krastorio2-spaced-out, Fluid-level-indicator, terrapalus, Krastorio2, secretas
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, Krastorio2-spaced-out, Krastorio2
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: metal-and-stars, secretas, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: RenaiTransportation, PavementDriveAssistContinued, secretas, Moshine
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: PlutoniumEnergy, secretas, StopgapNukes
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: quirkycat_base, quirkycat_boron
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: quirkycat_base, quirkycat_glass
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: rubia, VoidProcessing
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: tenebris-prime, tenebris
-- Severity: MEDIUM
-- Type: item
...
-- Fixes conflict between: Cold_biters, cubium, crushing-industry, astroponics, bztin, WaterExtractor, wood-industry, planet-muluna, Moshine-assets, biochemistry, corrundum, dea-dia-system, cerys-lunaponics, quirkycat_glass, vulcanus-sulfuric-bacteria, bobplates, rubia, castra, Spaghetorio, Cerys-Moon-of-Fulgora, aai-industry, secretas, bzcarbon, bzlead, metal-and-stars, Krastorio2-spaced-out, quirkycat_boron, Paracelsin, StopgapNukes, bobgreenhouse, bobelectronics, bztitanium, bobrevamp, lignumis, bzsilicon, terrapalus, Krastorio2, bzzirconium
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: metal-and-stars, astroponics, bobplates, janus, castra, bobrevamp, boblogistics, planet-muluna, bobelectronics, aai-industry
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: metal-and-stars, Krastorio2-spaced-out, bobplates, castra, bobrevamp, wood-industry, boblogistics, planet-muluna, biochemistry, lilys-cubeine, Krastorio2, bobelectronics, aai-industry, corrundum, secretas, terrapalus, bobwarfare
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: Cold_biters, cubium, wood-industry, planet-muluna, biochemistry, corrundum, bobplates, rubia, castra, boblogistics, lilys-cubeine, Cerys-Moon-of-Fulgora, aai-industry, metal-and-stars, Krastorio2-spaced-out, bobelectronics, bobrevamp, Krastorio2, bobwarfare
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: Cold_biters, cubium, bztin, wood-industry, planet-muluna, Moshine-assets, corrundum, bobplates, castra, boblogistics, lilys-cubeine, aai-industry, bzcarbon, Krastorio2-spaced-out, StopgapNukes, bobgreenhouse, bobelectronics, VoidProcessing, bobrevamp, Krastorio2
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: aai-vehicles-ironclad, StopgapNukes, Moshine
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: aai-vehicles-ironclad, cubium, Krastorio2-spaced-out, wood-military, RPGsystem, Nuclear_Artillery_QF, More_Ammo, RampantArsenalFork, RampantFixed, Krastorio2, bobvehicleequipment, bobwarfare, bzzirconium
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: Krastorio2-spaced-out, RPGsystem, StopgapNukes, Krastorio2, Aircraft-space-age
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: metal-and-stars, Krastorio2-spaced-out, alien-module, lignumis, StopgapNukes, More_Ammo, vtk-cannon-turret, Aircraft-space-age, Krastorio2, bobwarfare, PlutoniumEnergy, bzzirconium, grappling-gun
-- Severity: LOW
...
-- Fixes conflict between: Cold_biters, metal-and-stars, Hovercrafts, bobplates, tenebris-prime, rubia, castra, promethium-quality, lilys-cubeine, Cerys-Moon-of-Fulgora, Aircraft-space-age, secretas, tenebris, dea-dia-system
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: combat-mechanics-overhaul, alien-biomes
-- Severity: LOW
...
-- Fixes conflict between: Krastorio2-spaced-out, alien-module, Electric_flying_enemies, StopgapNukes, Krastorio2, corrundum, bobwarfare, PlutoniumEnergy, bzzirconium
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: cubium, Krastorio2-spaced-out, aquilo-seabloom-algaculture, promethium-quality, Spaghetorio, biochemistry, Cerys-Moon-of-Fulgora, cerys-lunaponics, bzcarbon
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: Cold_biters, cubium, Krastorio2-spaced-out, bobplates, aquilo-seabloom-algaculture, lignumis, wood-industry, Moshine-assets, Cerys-Moon-of-Fulgora, corrundum, Krastorio2, secretas, dea-dia-system, vulcanus-sulfuric-bacteria, Moshine
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: cubium, VoidProcessing, corrundum, aquilo-seabloom-algaculture
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: metal-and-stars, cubium, Krastorio2-spaced-out, aquilo-seabloom-algaculture, promethium-quality, corrundum, VoidProcessing
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: cerys-lunaponics, astroponics, lilys-cubeine
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: biochemistry, lilys-cubeine, astroponics
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: Cold_biters, cubium, crushing-industry, astroponics, bztin, wood-industry, biochemistry, corrundum, vulcanus-sulfuric-bacteria, bobplates, slp-dyson-sphere-reworked, castra, Spaghetorio, se-space-trains, Cerys-Moon-of-Fulgora, tenebris-prime, bzcarbon, bzlead, Krastorio2-spaced-out, bobelectronics, tenebris, PlutoniumEnergy, More_Ammo, Moshine, bzsilicon, Krastorio2, bobwarfare, bzzirconium
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: wood-military, Krastorio2-spaced-out, Nuclear_Artillery_QF, StopgapNukes, Krastorio2, bobwarfare, atomic-artillery-reborn, PlutoniumEnergy
-- Severity: LOW
-- Type: create-explosion
...
-- Fixes conflict between: cubium, biochemistry, fulgora-coralmium-agriculture
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: metal-and-stars, crushing-industry, foundry-restructuring, Spaghetorio, bzsilicon, vulcanus-sulfuric-bacteria, biochemistry, bzzirconium, bzlead
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: bobwarfare, bobelectronics, bobplates
-- Severity: LOW
-- Type: item-subgroup
...
-- Fixes conflict between: bobenemies, bobvehicleequipment, bobwarfare
-- Severity: LOW
-- Type: damage-type
...
-- Fixes conflict between: Spaghetorio, Krastorio2-spaced-out, Krastorio2, boblogistics
-- Severity: LOW
-- Type: virtual
...
-- Fixes conflict between: Krastorio2-spaced-out, Spaghetorio, boblogistics, RampantFixed, Krastorio2
-- Severity: LOW
-- Type: virtual
...
-- Fixes conflict between: metal-and-stars, snouz-big-accumulator, Krastorio2-spaced-out, Spaghetorio, bobpower, Krastorio2
-- Severity: LOW
-- Type: virtual
...
-- Fixes conflict between: bobvehicleequipment, bobwarfare
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: Krastorio2-spaced-out, Nuclear_Artillery_QF, RampantArsenalFork, Krastorio2, bobvehicleequipment, bobwarfare, PlutoniumEnergy
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: bobwarfare, RPGsystem, Kux-OrbitalIonCannon
-- Severity: LOW
-- Type: create-fire
...
-- Fixes conflict between: bobwarfare, More_Ammo, Kux-OrbitalIonCannon
-- Severity: LOW
-- Type: create-fire
...
-- Fixes conflict between: Krastorio2-spaced-out, Nuclear_Artillery_QF, RampantArsenalFork, Krastorio2, bobwarfare
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: bobwarfare, Krastorio2-spaced-out, Krastorio2
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: rubia, castra, bobwarfare
-- Severity: LOW
-- Type: virtual
...
-- Fixes conflict between: Krastorio2-spaced-out, bzsilicon, Krastorio2, bztitanium, bzcarbon
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: Krastorio2-spaced-out, bztin, Krastorio2, bztitanium, bzzirconium, bzcarbon, bzlead
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: Krastorio2-spaced-out, Krastorio2, bzcarbon
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: bztin, bzsilicon, bztitanium, bzzirconium, bzcarbon, bzlead
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: bztin, bzsilicon, bztitanium, bzzirconium, bzlead
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: metal-and-stars, cubium, Krastorio2-spaced-out, bztin, Spaghetorio, Moshine-assets
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: StopgapNukes, castra, corrundum
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: metal-and-stars, crushing-industry, Krastorio2-spaced-out, Paracelsin, foundry-restructuring, castra, Spaghetorio, Moshine-assets, common-prototypes, Moshine
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: rubia, castra, fulgora-coralmium-agriculture, Cerys-Moon-of-Fulgora
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: combat-mechanics-overhaul, enemyracemanager
-- Severity: LOW
-- Type: collision-layer
...
-- Fixes conflict between: slp-dyson-sphere-reworked, cubium, VoidProcessing, corrundum
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: slp-dyson-sphere-reworked, cubium, corrundum
-- Severity: LOW
-- Type: fluid
...
-- Fixes conflict between: RenaiTransportation, cubium, wood-military
-- Severity: LOW
-- Type: create-entity
...
-- Fixes conflict between: RampantFixed, enemyracemanager, RampantArsenalFork
-- Severity: LOW
-- Type: damage-type
...
-- Fixes conflict between: Spaghetorio, Krastorio2-spaced-out, Krastorio2
-- Severity: LOW
-- Type: virtual
